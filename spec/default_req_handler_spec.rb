...
describe 'Default Request Handler' do
  it "q of 'Buddhism' should get 11,000 - 12,000 results", jira: 'VUF-160' do
    ...
    resp.should have_at_least(11_000).documents
    resp.should have_at_most(12_000).documents
  end
  ...
  it 'like titles should appear together in result', jira: 'VUF-93' do
    ...
    resp.should include(%w(6974167 5757985 1630776 4364566 4406971)).in_first(10)
  ...
  it 'history of the jews by paul johnson', jira: 'VUF-510' do
    ...
    resp.should include(%w(1665541 3141358)).in_first(3).results
  end
  ...
  it "'call of the wild'", jira: 'VUF-171' do
    ...
    resp.should include(%w(6635999 2472361 3240949 3431568 4410827
  ...
  it 'zeitschrift', jira: 'VUF-511' do
    ...
    resp.should include(%w(4443145 486819)).in_first(10) # has 245a of Zeitschrift
  ...
  it 'happiness, a history', jira: 'VUF-1065' do
    ...
    resp.should include(%w(6549586 8446470)).in_first(3)
  end
  ...
  it 'the atomic' do
    ...
    resp.should have_at_least(12_000).results
  ...
  it 'on the road' do
    ...
    resp.should have_at_least(16_500).results
  ...
  it 'war and peace' do
    ...
    resp.should have_at_least(14_250).results
