describe "Author-Title Search" do
  ...
  it "Steinbeck Pearl", :jira => 'SW-778' do
    ...
    resp = solr_response(author_title_search_args(q).merge!({'fl'=>'id,author_person_display', 'facet'=>false, 'fq' => 'format_main_ssim:Book' }))
  ...
  context "Shakespeare, William, 1564-1616. All's well that ends well.", :jira => ['SW-138', 'SW-476'] do
    it "Shakespeare, William, 1564-1616. All's well that ends well." do
      ...
      resp = solr_response(author_title_search_args(q).merge!({'fl'=>'id,author_person_display,title_245a_display,score', 'rows'=>50, 'facet'=>false, 'fq' => 'format_main_ssim:Book' }))
