describe 'Greek script' do
  context 'alpha A α' do
    it 'α in και' do
      resp = solr_response('q' => 'και', 'fl' => 'id,vern_title_245a_display', fq: 'date_cataloged:* AND access_facet:"At the Library"', 'facet' => false)
      ...
      expect(resp).to have_the_same_number_of_results_as(solr_resp_doc_ids_only('q' => 'κΑι', fq: 'date_cataloged:* AND access_facet:"At the Library"'))
    end
  end
  #  context "beta Β β" do
