...
describe 'Greek script' do
  ...
  it 'επιμελεια' do
    ...
    resp.should include(%w(8774108 7822463 7739251 7739278 7901590 8923317))
  end

  it 'εκδοσης' do
    resp = solr_resp_doc_ids_only('q' => 'εκδοσης')
    resp.should include(%w(7822463 7739278))
  end

  it 'Βυζαντιο' do
    resp = solr_resp_doc_ids_only('q' => 'Βυζαντιο')
    resp.should include(%w(7822463 7881455 7902361))
  end
end
