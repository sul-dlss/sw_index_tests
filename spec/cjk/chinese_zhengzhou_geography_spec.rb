  ...
  context "everything search" do
    shared_examples_for "great search results for 郑州地理" do
      ...
      it "should rank high the documents with one word in 245a" do
        ...
        expect(resp).to include("11980491").in_first(15).results # zhengzhou 260a; geography 520a
      ...
      it "should rank less high the documents with both words present but not in 245" do
        ...
        expect(resp).to include("5456407") # zhengzhou in 260a,  geography in 260b, 710b
      end
    end
