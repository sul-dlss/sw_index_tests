  ...
  context "everything search" do
    shared_examples_for "great search results for 郑州地理" do
      ...
      it "should rank high the documents with one word in 245a" do
        resp.should include("4203541").in_first(9).results  # geography in 245a 490a, 830a;  郑州 (zhengzhou) in 260a
        #  geography in 245a; zhengzhou in 260a
        resp.should include("5809974").in_first(9).results # zhengzhou 260a; geography 245a
        resp.should include("10111516").in_first(9).results # zhengzhou (simp) 260a;  geography 245a
        resp.should include("4197620").in_first(9).results # zhengzhou 260a, geography 245a
        resp.should include("4808042").in_first(9).results # zhengzhou 260a, geography 245a
        resp.should include("6704074").in_first(9).results # zhengzhou 260a, geography 245a
      end
