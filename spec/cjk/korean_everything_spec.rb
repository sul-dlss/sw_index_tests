...
describe "Korean Everything", :korean => true, skip: 'waiting for solr 7' do
  ...
  context "Hangul: social change", :jira => 'VUF-2776' do
    ...
    context "사회변동 (no spaces)" do
      ...
      it_behaves_like 'best matches first', 'everything', '사회변동', bigrams_in_245_wrong_order, 80, 'rows'=>85
    end
