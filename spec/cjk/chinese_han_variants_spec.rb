...
describe 'Chinese Han variants', chinese: true do
  context 'Guangxu (pinyin input method vs our data)', jira: ['VUF-2757', 'VUF-2751'] do
    ...
    it_behaves_like 'both scripts get expected result size', 'everything', 'with dot', '光緖', 'without dot', '光緒', 5550, 6550
    it_behaves_like 'both scripts get expected result size', 'everything', 'traditional (with dot)', '光緖', 'simplified', '光绪', 5550, 6550
    it_behaves_like 'both scripts get expected result size', 'everything', 'without dot', '光緒', 'simplified', '光绪', 5550, 6550
    context 'with dot U+7DD6  緖' do
      it_behaves_like 'expected result size', 'everything', '光緖', 5550, 6550
    end
    context 'without dot U+7DD2 緒' do
      it_behaves_like 'expected result size', 'everything', '光緒', 5550, 6550
    end
    context 'simplified U+7EEA 绪' do
      it_behaves_like 'expected result size', 'everything', '光绪', 5550, 6550
    end
  end
