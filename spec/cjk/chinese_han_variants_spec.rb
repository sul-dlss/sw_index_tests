...
describe "Chinese Han variants", :chinese => true do
  ...
  context "Guangxu (pinyin input method vs our data)", :jira => ['VUF-2757', 'VUF-2751'] do
    ...
    it_behaves_like "both scripts get expected result size", 'everything', 'without dot', '光緒', 'simplified', '光绪', 5000, 6000
    context "with dot U+7DD6  緖" do
      it_behaves_like "expected result size", 'everything', '光緖', 5000, 6000
    end
    context "without dot U+7DD2 緒" do
      it_behaves_like "expected result size", 'everything', '光緒', 5000, 6000
    end
  ...
  context "history research" do
    ...
    context "no spaces" do
      it_behaves_like "both scripts get expected result size", 'title', 'traditional', '歷史研究', 'simplified', '历史研究', 562, 1500
