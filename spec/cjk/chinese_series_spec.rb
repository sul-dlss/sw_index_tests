...
describe "Chinese Series", :chinese => true do
  ...
  context "contemporary literary criticism", :jira => 'VUF-2768' do
    ...
    it_behaves_like "best matches first", 'series', '当代文学批评', ['4470843', '10216694', '10357498', '9853238', '9652358', '10139659', '8931473'], 8
    context "phrase" do
      ...
      it_behaves_like "good results for query", 'series', '"中国当代文学研究与批评书系"', 4, 6, ['10357498', '9853238', '9652358', '10139659', '8931473'], 5
    end
  end
