...
describe "Japanese Everything Searches", :japanese => true do
  ...
  context 'Edo (old name for Tokyo)', :jira => ['VUF-2726', 'VUF-2770'] do
    ...
    it_behaves_like "expected result size", 'everything', '江戶', 1955, 1990, lang_limit  # trad
    it_behaves_like "expected result size", 'everything', '江戸', 1955, 1990, lang_limit  # modern
