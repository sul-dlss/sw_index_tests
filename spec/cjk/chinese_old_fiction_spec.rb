...
#    shared_examples_for "great search results for 舊小說" do |resp|
#      describe do
...
#      shared_examples_for "great title search results for 舊小說" do |resp|
#        describe do
...
#      shared_examples_for "great everything search results for 舊小說" do |resp|
#        describe do
          it "gets a reasonable number of results" do
