...
describe "Korean: Hangul and Hancha scripts", :korean => true, :fixme => true do
  ...
  it "hangul  광주 should get results for hancha  光州" do
    ...
    expect(resp).to include(["7763372", "7773313"]) # hancha  光州
    expect(resp.size).to be >= 110 # 87 in prod (87 korean), 115 in soc (115 Korean)
  end
  ...
  it "hancha (simplified)  光州 for Korean language should include the hangul  광주 results" do
    ...
    expect(resp).to include(["8579366", "8536590"])  # hangul  광주
    expect(resp.size).to be >= 45 # 22 in prod (21 korean), 701 in soc (50 Korean)
  end
  ...
  it "hancha (traditional)  廣州 for Korean language should include the hancha simplified  光州 results" do
    ...
    expect(resp).to include(["7763372", "7773313"]) # hancha  光州
    expect(resp.size).to be >= 9 # 1928 in prod (2 korean), 4739 in soc (9 Korean)
  end
